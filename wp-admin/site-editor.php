...
if ( ! ( current_theme_supports( 'block-template' ) || wp_is_block_theme() ) ) {
...
$custom_settings      = array(
	...
	'supportsTemplatePartsMode' => ! wp_is_block_theme() && current_theme_supports( 'block-template' ),
);
...
$preload_paths = array(
	...
	'/wp/v2/template?context=edit&per_page=-1',
